...
class UFD(Domain, abc.ABC):
    ...
    def is_prime(self, p):
        ...
        :param p: self.element_type - element to be checked
    ...
    def factor(self, a):
        ...
        :param a: self.element_type - element to be factorized
        :return: [self.element_type] - list of prime elements that decompose a
        """
        # TODO break RSA :)
        raise NotImplementedError
...
class EuclideanDomain(UFD, abc.ABC):
    ...
    def value(self, a):
        ...
        :param a: self.element_type - element for which compute the Euclidean function
    ...
    def quot(self, a, b):
        ...
        :param a: self.element_type - dividend
        :param b: self.element_type - divisor
        :return: self.element_type - quotient of the division
        """
    ...
    def rem(self, a, b):
        ...
        :param a: self.element_type - dividend
        :param b: self.element_type - divisor
        :return: self.element_type - remainder of the division
        """
    ...
    def full_div(self, a, b):
        ...
        :param a: self.element_type - dividend
        :param b: self.element_type - divisor
        :return: (self.element_type, self.element_type) - quotient and remainder of the division
        """
        raise NotImplementedError
    ...
    def divides(self, a, b):
        ...
        :param a: self.element_type - left-hand-side element
        :param b: self.element_type - right-hand-side
    ...
    def gcd(self, a, b):
        ...
        :param a: self.element_type - left-hand-side element
        :param b: self.element_type - right-hand-side element
        :return: self.element_type - greatest common divisor of a and b
        """
        raise NotImplementedError
    ...
    def lcm(self, a, b):
        ...
        :param a: self.element_type - left-hand-side element
        :param b: self.element_type - right-hand-side element
        :return: self.element_type - least common multiple of a and b
        """
    ...
    def bezout(self, a, b):
        ...
        :param a: self.element_type - left-hand-side element
        :param b: self.element_type - right-hand-side element
        :return: (self.element_type, self.element_type) - two elements that satisfy Bezout's identity
        """
        raise NotImplementedError
